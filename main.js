// MAIN.js FILE CONTENTS: Search logic/functionality and UI updates.

console.log("Main.js loaded!"); // Just for when we de-bug, can be deleted at some point before we put on github.
import { fetchSearchResults } from "./api.js";

//Event listener so that the scripts only run after page is loaded.
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Allows exit early if page loads w/o the search form
    if (!searchForm) {
    ...
    // Handles our Search Type Selection, to update input field when the user changes the search type.
    ...
    // Handles our Search Submission, validates user input & form submission to navicate to results page.
...
// ANOTHERRRR Helper function to clean gene names
